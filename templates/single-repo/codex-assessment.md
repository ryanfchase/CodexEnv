...
- Promote to `operational` when the intended normal workflow has at least one successful validation pass and the remaining readiness checks are no longer partial or blocked.
